function Hero() {
  return (
    <section className="hero" id="about">
      <p className="hero-eyebrow">Versatile Technologist</p>
      <h1>Zyionne Odafe <span>Hasani Ibrahim</span></h1>
      <h2>Building my tech career from the ground up.</h2>
      <p>
        I am a dedicated and passionate technologist on a deliberate journey to have a dynamic, accomplished, and multidisciplinary career in Software Engineering, 
